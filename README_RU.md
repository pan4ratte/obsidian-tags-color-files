...
### 5. Окрашивание ссылок на заметки

Опционально можно окрашивать и ссылки на заметки внутри ваших заметок — как в редакторе, так и в режиме просмотра. Ссылка принимает цвет заметки, на которую она указывает. Окрашивается только текст ссылки, независимо от выбранного способа окрашивания.
