export default {
    ...
    ADD_RULE_DESC: 'Введите тег и укажите цвет окрашивания. Используйте области папок для группировки правил. Чем выше правило в списке, тем больший у него приоритет.',
