export default {
	...
	ADD_RULE_NAME: "Выберите тип создаваемого правила",
	ADD_RULE_DESC: "Общее правило применяется ко всем файлам. Правило для папки — только к файлам внутри указанной папки.",
	ADD_RULE_BTN: "Новое правило",
	ADD_FOLDER_RULE_BTN: "Правило для папки",
