export default {
	...
	ADD_RULE_DESC:
		"Введите тег и укажите цвет окрашивания. Если к файлу добавлено несколько тегов, для которых создано правило, выбирается приоритетный: чем выше правило в списке, тем больший у него приоритет.",
