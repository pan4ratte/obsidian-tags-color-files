...
1. I am not a programmer, and the plugin code was almost entirely generated by a neural network. Considering this, the plugin requires a full code audit for cleanup and optimization.
