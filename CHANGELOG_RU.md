...
* Исправлена ошибка: при прокрутке проводника и раскрытии папок новые файлы появлялись без цвета и окрашивались с задержкой. После запуска Obsidian файлы теперь окрашиваются сразу, а не через полсекунды.
* Исправлена ошибка: в проводнике и представлениях Bases, открытых в новом окне, файлы могли оставаться без цвета.
